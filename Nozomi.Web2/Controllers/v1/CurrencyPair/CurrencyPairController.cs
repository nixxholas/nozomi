...
namespace Nozomi.Web2.Controllers.v1.CurrencyPair
{
    ...
    public class CurrencyPairController : BaseApiController<CurrencyPairController>, ICurrencyPairController
    {
        ...
        [Obsolete]
        public NozomiResult<ICollection<Data.Models.Categorisation.ItemPair>> Ticker(string abbrv)
        {
            return new NozomiResult<ICollection<Data.Models.Categorisation.ItemPair>>(
