...
namespace Nozomi.Web2.Controllers.v1.CurrencyType
{
    public class CurrencyTypeController : BaseApiController<CurrencyTypeController>, ICurrencyTypeController
    {
        ...
        [HttpGet]
        [Throttle(Name = "ItemType/All", Milliseconds = 100)]
        ...
        [HttpPost]
        [Throttle(Name = "ItemType/Create", Milliseconds = 1000)]
        ...
        [HttpGet]
        [Throttle(Name = "ItemType/ListAll", Milliseconds = 1000)]
        ...
        [Authorize(Roles = NozomiPermissions.AllowAllStaffRoles)]
        [HttpPut]
        [Throttle(Name = "ItemType/Update", Milliseconds = 1000)]
