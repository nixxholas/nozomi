<template>
    <div>
            ...
            <div class="hero-body">
                <div class="columns is-centered">
                    <div class="column is-5 is-offset-1 landing-caption">
                        ...
                        <h2 class="subtitle is-5 is-muted">We’re an API-first data company delivering retrograde market
                            data and
                            aggregating APIs to products that require a strong and reliable data backbone.</h2>
                        <p>
        ...
        <section class="hero is-medium">
            <div class="hero-body">
                <h1 class="title is-1 is-bold is-spaced pb-3">
                    Timeline
                </h1>
                <div class="timeline is-centered">
                    <header class="timeline-header">
                        <span class="tag is-medium is-primary">Genesis</span>
                    </header>
                    <div class="timeline-item">
                        <div class="timeline-marker is-primary"></div>
                        <div class="timeline-content">
                            <p class="heading">April 2018</p>
                            <p>Side project kickoff</p>
                        </div>
                    </div>
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Wrapping engine completion</p>
                        </div>
                    </div>
                    <header class="timeline-header">
                    ...
                    <header class="timeline-header">
                        <span class="tag is-medium is-primary">World domination</span>
                    </header>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <p class="title is-5 has-text-black">Jasper Chua</p>
                                                <p class="subtitle is-6 has-text-black">Contributions to Nozomi's First
                                                    Business Plan</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="column">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="media">
                                            <div class="media-content">
                                                <p class="title is-5 has-text-black">Elvis Yong</p>
                                                <p class="subtitle is-6 has-text-black">Contributions to Nozomi's First
                                                    Web App</p>
                                            </div>
                                        </div>
