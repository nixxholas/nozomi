...
namespace Nozomi.Repo.Migrations
{
    ...
    [Migration("20181007092039_r3.1_RefactorCPCRedundantMap")]
    partial class r31_RefactorCPCRedundantMap
    {
            ...
            modelBuilder.Entity("Nozomi.Data.WebModels.CurrencyPairRequest", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), CreatedBy = 0L, DataPath = "https://api.ethfinex.com/v2/ticker/tETHUSD", Delay = 5000, DeletedBy = 0L, Guid = new Guid("1afc1fad-bf6c-4d02-9d13-3f187f52f419"), IsEnabled = true, ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ModifiedBy = 0L, RequestType = 0, CurrencyPairId = 1L },
                        new { Id = 2L, CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), CreatedBy = 0L, DataPath = "https://api.ethfinex.com/v2/ticker/tKNCUSD", Delay = 5000, DeletedBy = 0L, Guid = new Guid("8e84085d-5e80-477f-9d9d-0751f044124d"), IsEnabled = true, ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ModifiedBy = 0L, RequestType = 0, CurrencyPairId = 2L }
                    );
                });
            ...
            modelBuilder.Entity("Nozomi.Data.CurrencyModels.CurrencyPairComponent", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, CreatedAt = new DateTime(2018, 10, 7, 17, 20, 38, 583, DateTimeKind.Local), CreatedBy = 0L, DeletedBy = 0L, IsEnabled = true, ModifiedAt = new DateTime(2018, 10, 7, 17, 20, 38, 585, DateTimeKind.Local), ModifiedBy = 0L, QueryComponent = "1", RequestId = 1L, ComponentType = 1, CurrencyPairId = 1L },
                        new { Id = 2L, CreatedAt = new DateTime(2018, 10, 7, 17, 20, 38, 585, DateTimeKind.Local), CreatedBy = 0L, DeletedBy = 0L, IsEnabled = true, ModifiedAt = new DateTime(2018, 10, 7, 17, 20, 38, 585, DateTimeKind.Local), ModifiedBy = 0L, QueryComponent = "0", RequestId = 1L, ComponentType = 2, CurrencyPairId = 1L },
                        new { Id = 3L, CreatedAt = new DateTime(2018, 10, 7, 17, 20, 38, 585, DateTimeKind.Local), CreatedBy = 0L, DeletedBy = 0L, IsEnabled = true, ModifiedAt = new DateTime(2018, 10, 7, 17, 20, 38, 585, DateTimeKind.Local), ModifiedBy = 0L, QueryComponent = "0", RequestId = 2L, ComponentType = 1, CurrencyPairId = 2L }
                    );
                });
