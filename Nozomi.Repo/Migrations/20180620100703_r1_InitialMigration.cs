        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QueryComponent = table.Column<string>(nullable: false),
                    Value = table.Column<decimal>(nullable: false),
                    CurrencyPairId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrencyPairComponents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurrencyPairComponents_CurrencyPairs_CurrencyPairId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrencyPairComponents_CurrencyPairId",
