...
namespace Nozomi.Repo.Migrations
{
    ...
    [Migration("20180930144136_r2_CurrencyPairRequestComponentRefactoring")]
    partial class r2_CurrencyPairRequestComponentRefactoring
    {
            ...
            modelBuilder.Entity("Nozomi.Data.WebModels.CurrencyPairRequest", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), CreatedBy = 0L, DataPath = "https://api.ethfinex.com/v2/ticker/tETHUSD", Delay = 5000, DeletedBy = 0L, Guid = new Guid("d5c80dd7-bf49-4f36-95f5-1fe2347359c7"), IsEnabled = true, ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ModifiedBy = 0L, RequestType = 0, CurrencyPairId = 1L },
                        new { Id = 2L, CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), CreatedBy = 0L, DataPath = "https://api.ethfinex.com/v2/ticker/tKNCUSD", Delay = 5000, DeletedBy = 0L, Guid = new Guid("fe10c3c4-6064-40ad-86f9-50ebf948c933"), IsEnabled = true, ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ModifiedBy = 0L, RequestType = 0, CurrencyPairId = 2L }
                    );
                });
            ...
            modelBuilder.Entity("Nozomi.Data.CurrencyModels.CurrencyPairComponent", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, CreatedAt = new DateTime(2018, 9, 30, 22, 41, 35, 455, DateTimeKind.Local), CreatedBy = 0L, DeletedBy = 0L, IsEnabled = true, ModifiedAt = new DateTime(2018, 9, 30, 22, 41, 35, 458, DateTimeKind.Local), ModifiedBy = 0L, QueryComponent = "0", RequestId = 1L, ComponentType = 1, CurrencyPairId = 1L },
                        new { Id = 2L, CreatedAt = new DateTime(2018, 9, 30, 22, 41, 35, 458, DateTimeKind.Local), CreatedBy = 0L, DeletedBy = 0L, IsEnabled = true, ModifiedAt = new DateTime(2018, 9, 30, 22, 41, 35, 458, DateTimeKind.Local), ModifiedBy = 0L, QueryComponent = "0", RequestId = 2L, ComponentType = 1, CurrencyPairId = 2L }
                    );
                });
