...
namespace Nozomi.Repo.Migrations
{
    ...
    [Migration("20200409094313_r16_ItemERD")]
    partial class r16_ItemERD
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.Item", b =>
                {
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.ItemPair", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.ItemProperty", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.ItemSource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("ItemGuid", "SourceId")
                        .IsUnique();

                    b.ToTable("ItemSources");
                });

            modelBuilder.Entity("Nozomi.Data.Models.Category.ItemType", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.Item", b =>
                {
                    b.HasOne("Nozomi.Data.Models.Category.ItemType", "ItemType")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Category.ItemProperty", b =>
                {
                    b.HasOne("Nozomi.Data.Models.Category.Item", "Item")
            ...
            modelBuilder.Entity("Nozomi.Data.Models.Web.Request", b =>
                {
                    ...
                    b.HasOne("Nozomi.Data.Models.Category.ItemPair", "ItemPair")
                        .WithMany("Requests")
                        .HasForeignKey("ItemPairGuid")
                        .OnDelete(DeleteBehavior.Cascade);
