...
{
    public class CurrencyMap : BaseMap<Item>
    {
        public CurrencyMap(EntityTypeBuilder<Item> entityTypeBuilder) : base(entityTypeBuilder)
        {
            ...
            //     .IsRequired(false);
            // entityTypeBuilder.HasOne(c => c.ItemType).WithMany(ct => ct.Items)
