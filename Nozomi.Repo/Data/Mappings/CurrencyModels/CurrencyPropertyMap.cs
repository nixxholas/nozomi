...
{
    public class CurrencyPropertyMap : BaseMap<ItemProperty>
    {
        public CurrencyPropertyMap(EntityTypeBuilder<ItemProperty> entityTypeBuilder) : base(entityTypeBuilder)
        {
